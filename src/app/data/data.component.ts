...
export class DataComponent implements OnInit {
  ...
  monthlychecklist = [
    ...
    {id:73,value:'AWND',isSelected:false,title:'AWND - Average Daily Wind Speed',type:'Monthly'},
  ...
  constructor(
    ...
    ) 
    {
      ...
      this.checklist = this.hourchecklist.concat(this.dailychecklist.concat(this.monthlychecklist))
    }
  ...
  onChangeType(type: any){
    if(type.target.value == "All"){
      let temp = this.hourchecklist.concat(this.dailychecklist)
      let temp2 = this.monthlychecklist.concat(this.miscchecklist)
      this.allList = temp.concat(temp2)
      this.checklist = this.allList
      this.displayList = this.checkedList
    }
    else if(type.target.value == "Hourly"){
      this.checklist = this.hourchecklist;
      this.displayList = this.checkedList

    }
    else if(type.target.value == "Daily"){
      this.checklist = this.dailychecklist;
      this.displayList = this.checkedList

    }
    else if(type.target.value == "Monthly"){
      this.checklist = this.monthlychecklist;
      this.displayList = this.checkedList

    }
    else if(type.target.value == "Misc"){
      this.checklist = this.miscchecklist
      this.displayList = this.checkedList
